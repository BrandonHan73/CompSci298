...
public class Config {
	...
	public static int fictitious_play_iterations = 1 << 9;
	public static int fast_fictitious_play_iterations = 1 << 7;
	...
	public static int a2c_critic_pretrain_iterations = 1 << 9;
